...
This report binds the #610 runtime implementation to the approved Direction B checkpoint and the refreshed exact-source runtime evidence after the #612 city shell, #613 map UX, and #623 single-player fog-privacy changes. On 2026-09-05, the operator approved all three refreshed exact-source runtime frames promoted at `ec86cebf1d0d4c70c2a670f142bdddf6fab265ee`; the approval is recorded in [issue #610](https://github.com/jharvieux/AoP/issues/610#issuecomment-5555063774). The files were captured from runtime/source ancestor `c1824f22bf14dca6d38f7519fd99affd789a8130`.
