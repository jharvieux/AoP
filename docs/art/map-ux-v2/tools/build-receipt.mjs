...
export const captureSpecs = [
  ...
  },
  {
    ...
    height: 390,
    mode: 'single-player',
    state: 'full collision fixture; compact horizontal navigation',
    primary: true,
  },
  {
...
export function validateReceipt(receipt) {
  ...
  if (receipt.capability_gates.touch_recording.status !== 'pending-external') {
    throw new Error('touch gate must remain pending-external')
  }
  ...
  const receipt = {
    ...
    capability_gates: {
      touch_recording: {
        ...
        reason:
          'No connected physical/simulator device; IAB exposes no multitouch video recording.',
      },
    },
    captures,
  }
