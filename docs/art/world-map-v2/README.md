...
Fresh phone/tablet/desktop captures from exact runtime head
`09368902401310bf9a43455865f1151a6bb02d87` now show that repaired runtime and await
renewed checkpoint-2 approval for their exact pixels. Visibility and gameplay rules are
unchanged.
...
- Checkpoint 1 approved the art direction. The refreshed
  [runtime capture record](RUNTIME-CAPTURES.md) is bound to exact runtime head
  `09368902401310bf9a43455865f1151a6bb02d87` (whose runtime/art bytes match the
  complete-fleet repair at `7c4c56d7a28baea8a7f176e51fadd15d70353648`) and awaits
  renewed checkpoint-2 approval.
...
[runtime capture record](RUNTIME-CAPTURES.md) from exact runtime head
`09368902401310bf9a43455865f1151a6bb02d87` now pictures that repaired runtime. Those exact
