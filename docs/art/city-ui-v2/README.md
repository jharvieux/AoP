...
> **#613 evidence approved:** the operator approved these 20 replacement pixels at evidence
> head `08717289778883d7adca6ff7a6f15b20fb7c6b25`, captured and inspected against exact
> source `c1824f22bf14dca6d38f7519fd99affd789a8130`. The durable approval is recorded in
> [issue #612](https://github.com/jharvieux/AoP/issues/612#issuecomment-5555069230).
...
inspection of every replacement file before the operator approved checkpoint 2.
