 ...
 * refetch-driven architecture (Realtime pokes plus a safety-net poll, #260) a
 * conflict is routinely just another seat's AI auto-play bumping `action_count`
 * between refetches, so the original intent is very often still valid — one retry costs
