...
/**
 * Leaderboards (#154), the `@aop/shared` pure ranking/pagination module. Lives in the
 * engine suite for the same reason `rating.test.ts` (#151) does: a pure, I/O-free
 * `@aop/shared` module with no vitest setup of its own, borrowing the engine
 * package's. No coupling to the game engine itself.
 */
