...
// matches }. The quick-match queue drain — groups compatible waiters (same match_size + map_size,
// FIFO) into fresh matches, seats them, starts each match, and removes them from the queue.
//
