// get-player-view (docs/MULTIPLAYER.md §5, §7): POST { matchId } ->
// { seq, seat, view, turnDeadline }. THE anti-cheat boundary: the only path by which
...
// every hidden entity before serialization. Also the reconnect/resync path (§9).
...
import { callerSeat, reconstructState, seatPlayerId } from '../_shared/match.ts'
